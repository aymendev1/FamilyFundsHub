...
function TotalBalanceCard() {
  return (
    <div className=" bg-white rounded-lg relative font-[2rem] w-full h-[250px] p-4 flex flex-col gap-4 overflow-hidden max-xl:h-[200px] max-xl:gap-1 max-lg:w-full">
      ...
      <button className="bg-blue-950 hover:bg-blue-900 hover:delay-100 transition rounded-lg p-3 max-md:p-1 max-md:text-base text-slate-200 font-medium text-base">
        View More
      </button>
    </div>
  );
